var columns = [
    ...
    {id: 'author', field: 'authorName', name: 'Author', width: '15%'},
    {id: 'sender', field: 'senderName', name: 'Sender', width: '15%'},
    {id: 'recipient', field: 'recipientName', name: 'Recipient', width: '15%'},
